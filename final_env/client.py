...
class FinalEnv(
    EnvClient[FinalAction, FinalObservation]
):
    """
    Client for the Final Env Environment.
    ...
    Example with Docker:
        ...
        >>> client = FinalEnv.from_docker_image("final_env-env:latest")
        >>> try:
        ...     result = client.reset()
    ...
    def _parse_result(self, payload: Dict) -> StepResult[FinalObservation]:
        ...
        Returns:
            StepResult with FinalObservation
        """
